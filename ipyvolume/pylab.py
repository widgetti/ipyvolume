...
def directional_light(
    ...
    light.shadow.mapSize = tuple([shadow_map_size, shadow_map_size])
    ...
    light.userData = { 'shadowMapType': shadow_map_type }
...
def spot_light(
    ...
    light.shadow.camera.aspect = shadow_camera_perspective_aspect
