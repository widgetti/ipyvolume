...
class TransferFunctionWidgetJs3(TransferFunction):
	...
	def control(self):
		...
		o1 = ipywidgets.FloatSlider(min=0, max=0.1, step=0.001, value=self.opacity1)
		o2 = ipywidgets.FloatSlider(min=0, max=0.1, step=0.001, value=self.opacity2)
		o3 = ipywidgets.FloatSlider(min=0, max=0.1, step=0.001, value=self.opacity2)
